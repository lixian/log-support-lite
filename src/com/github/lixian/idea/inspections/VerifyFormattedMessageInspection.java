...
public class VerifyFormattedMessageInspection extends BaseJavaLocalInspectionTool {

    private LocalQuickFix appendPairsQuickFix = new AppendPairsToMessageQuickFix();

    private LocalQuickFix appendPlaceholdersQuickFix = new AppendPlaceholdersToMessageQuickFix();
